...
export const UploadComponent = ({ onFileUpload, isProcessing }: UploadComponentProps) => {
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            {selectedFile ? (
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500">
                  Drag & drop or click to select (MP4, AVI, MOV, JPG, PNG, etc.)
                </p>
        ...
        {selectedFile && uploadProgress === 100 && !isProcessing && (
          <div className="mt-6">
            <Button
              ...
              className="w-full bg-[#0fd1c8] text-white font-medium rounded-xl transition-all duration-200 transform hover:scale-[1.02]"
              size="lg"
            >
